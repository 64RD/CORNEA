...
import com.example.cornea.databinding.ActivityLeafBlightBinding
import com.example.cornea.R

class NorthernLeafBlight : AppCompatActivity() {

    private lateinit var binding: ActivityLeafBlightBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityLeafBlightBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.leafblight)
        }
