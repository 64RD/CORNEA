...
import com.example.cornea.databinding.ActivityBandedLeafandSheathBlightBinding
import com.example.cornea.R

class BandedleafandSheathBlight : AppCompatActivity() {

    private lateinit var binding: ActivityBandedLeafandSheathBlightBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBandedLeafandSheathBlightBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.banded)
        }
