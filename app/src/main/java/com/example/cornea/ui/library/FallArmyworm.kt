...
import com.example.cornea.databinding.ActivityFallArmywormBinding
import com.example.cornea.R

class FallArmyworm : AppCompatActivity() {

    private lateinit var binding: ActivityFallArmywormBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFallArmywormBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.fallarmyworm)
        }
