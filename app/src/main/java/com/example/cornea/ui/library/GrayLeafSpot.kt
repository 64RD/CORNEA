...
import com.example.cornea.databinding.ActivityGrayLeafSpotBinding
import com.example.cornea.R

class GrayLeafSpot : AppCompatActivity() {

    private lateinit var binding: ActivityGrayLeafSpotBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGrayLeafSpotBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.grayleafspot)
        }
