...
import com.example.cornea.databinding.ActivityDownyMildewBinding
import com.example.cornea.R

class DownyMildew : AppCompatActivity() {

    private lateinit var binding: ActivityDownyMildewBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDownyMildewBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.downymildew)
        }
