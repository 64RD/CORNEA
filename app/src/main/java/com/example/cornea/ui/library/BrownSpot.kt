...
import com.example.cornea.databinding.ActivityBrownSpotBinding
import com.example.cornea.R

class BrownSpot : AppCompatActivity() {

    private lateinit var binding: ActivityBrownSpotBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBrownSpotBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.brownspot)
        }
