...
import com.example.cornea.databinding.ActivityCornEarwormBinding
import com.example.cornea.R

class CornEarworm : AppCompatActivity() {

    private lateinit var binding: ActivityCornEarwormBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCornEarwormBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.cornearworm)
        }
