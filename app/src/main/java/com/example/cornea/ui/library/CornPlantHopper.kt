...
import com.example.cornea.databinding.ActivityCornPlanthopperBinding
import com.example.cornea.R

class CornPlantHopper : AppCompatActivity() {

    private lateinit var binding: ActivityCornPlanthopperBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCornPlanthopperBinding.inflate(layoutInflater)
        ...
        if (imageUri != null) {
            ...
            binding.imageView2.setImageResource(R.drawable.cornplanthopper)
        }
